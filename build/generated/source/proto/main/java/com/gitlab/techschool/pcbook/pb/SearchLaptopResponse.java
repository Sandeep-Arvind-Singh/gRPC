...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.gitlab.techschool.pcbook.pb.Laptop.Builder subBuilder = null;
            if (laptop_ != null) {
              subBuilder = laptop_.toBuilder();
            }
            laptop_ = input.readMessage(com.gitlab.techschool.pcbook.pb.Laptop.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.gitlab.techschool.pcbook.pb.SearchLaptopResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.gitlab.techschool.pcbook.pb.SearchLaptopResponse) e.getUnfinishedMessage();
    ...
    public Builder mergeLaptop(com.gitlab.techschool.pcbook.pb.Laptop value) {
      if (laptopBuilder_ == null) {
        if (laptop_ != null) {
          laptop_ =
            com.gitlab.techschool.pcbook.pb.Laptop.newBuilder(laptop_).mergeFrom(value).buildPartial();
        } else {
          laptop_ = value;
        }
        onChanged();
