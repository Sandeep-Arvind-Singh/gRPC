...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.gitlab.techschool.pcbook.pb.Filter.Builder subBuilder = null;
            if (filter_ != null) {
              subBuilder = filter_.toBuilder();
            }
            filter_ = input.readMessage(com.gitlab.techschool.pcbook.pb.Filter.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.gitlab.techschool.pcbook.pb.SearchLaptopRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.gitlab.techschool.pcbook.pb.SearchLaptopRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeFilter(com.gitlab.techschool.pcbook.pb.Filter value) {
      if (filterBuilder_ == null) {
        if (filter_ != null) {
          filter_ =
            com.gitlab.techschool.pcbook.pb.Filter.newBuilder(filter_).mergeFrom(value).buildPartial();
        } else {
          filter_ = value;
        }
        onChanged();
